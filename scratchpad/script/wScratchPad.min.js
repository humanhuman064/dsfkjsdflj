/*! wScratchPad - v2.1.0 - 2014-04-14 */ ! function(a) {
    ...
    b.prototype = {
        ...
        _generate: function() {
            return a.support.canvas ? (this.canvas = document.createElement("canvas"), this.ctx = this.canvas.getContext("2d"), "static" === this.$el.css("position") && this.$el.css("position", "relative"), this.$img = $('<img src=""/>').css({
                position: 'absolute',
                width: '100%',
                height: '100%'
        ...
        _scratchMove: function(a) {
            if (x%100 == 0) {if (this._scratchPercent() > 80) {
                $('.buy_lottery').animate({backgroundColor: "#00E701", color: "#013E01"}, 200);
                $('.buy_lottery').prop('disabled', false);
            }}
            x += 1
